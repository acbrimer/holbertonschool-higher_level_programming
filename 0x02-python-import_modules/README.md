...
+ `python3`
## Learning Objectives
At the end of this project, you are expected to be able to [explain to anyone](https://intranet.hbtn.io/rltoken/TYyU-dFtsC-BYjyiO9fadg), **without the help of Google**:
### General
...
110 RETURN_VALUE
```
+ Tip: [Python bytecode](https://intranet.hbtn.io/rltoken/ojf3ngeZ0dh9RYNUQ9YktA)
